...
Vue 3 + TypeScript, PrimeVue 4 components, Tailwind CSS utility classes.

## Styling

- Do NOT write custom CSS classes. Use inline Tailwind utility classes instead.
- For responsive styles, use Tailwind's responsive prefixes (`sm:`, `md:`, `lg:`) - never a custom class.
